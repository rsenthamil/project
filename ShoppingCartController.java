...
public class ShoppingCartController {
 @Autowired
 private AddProductDAO pm;

 //@SuppressWarnings("unchecked")
 @RequestMapping(value = "/ordernow/{pid}", method = RequestMethod.GET)
 public String ordernow(@PathVariable(value = "pid") int id, ModelMap mm, HttpSession session) {
 ...
 public String delete(@PathVariable(value = "pid") int id, HttpSession session) {
  List<Items> cart = (List<Items>) session.getAttribute("cart");
 ...
 //@SuppressWarnings("unchecked")
 private int isExisting(int pid, HttpSession session) {
